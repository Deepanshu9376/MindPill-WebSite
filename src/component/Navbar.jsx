...
const subLinks = [
  {
    ...
    link: "/homeawayhome/financialassitance",
  },
  {
    title: "Mental Assistance ",
    link: "/homeawayhome/mentalassistance",
  },
];
const Navbar = () => {
    ...
    <div className="flex h-[80px] items-center  border-b-[1px] bg-richblack-900 border-b-richblack-700">
      <div className="flex w-12/12  items-center  gap-[30px]">
        ...
        <nav className="flex flex-row gap-[135px]">
          <ul className="flex gap-x-[40px] text-richblack-25 mt-[5px]  text-2xl">
            {NavbarLinks.map((link, index) => (
              <li key={index}>
                {link.title === "Home /Away Home" ? (
